    ...
    <footer class="bg-white shadow-footer z-50 border-t border-accent-50 mt-5">
      <div class="w-full px-4 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8 max-w-7xl mx-auto text-center md:text-left">
          <!-- Liên Hệ -->
          <div>
            <h4 class="font-semibold text-neutral-1000 mb-4">{{ $t('footer.contact') }}</h4>
            <ul class="space-y-2 text-sm text-neutral-800">
              <li><a href="tel:+84123456789" class="text-primary-600 hover:text-neutral-700">{{ $t('footer.hotline') }}: +84 (0)123 456 789</a></li>
              <li><a href="mailto:konomi@email.com" class="text-primary-600 hover:text-neutral-700">{{ $t('footer.email') }}: konomi@email.com</a></li>
              <li><a href="#" class="text-primary-600 hover:text-neutral-700">{{ $t('footer.office') }}: 123 Đường ABC, Tp. HCM</a></li>
              <li><a href="#" class="text-primary-600 hover:text-neutral-700">{{ $t('footer.hours') }}: 8:00 - 22:00</a></li>
            </ul>
          </div>

          <!-- Hướng Dẫn Mua Hàng -->
          <div>
            <h4 class="font-semibold text-neutral-1000 mb-4">{{ $t('footer.guide') }}</h4>
            <ul class="space-y-2 text-sm text-neutral-800">
              <li><a href="#" class="text-primary-600 hover:text-neutral-700">{{ $t('footer.search') }}</a></li>
              <li><a href="#" class="text-primary-600 hover:text-neutral-700">{{ $t('footer.order') }}</a></li>
              <li><a href="#" class="text-primary-600 hover:text-neutral-700">{{ $t('footer.payment') }}</a></li>
              <li><a href="#" class="text-primary-600 hover:text-neutral-700">{{ $t('footer.promotions') }}</a></li>
            </ul>
          </div>

          <!-- Giao Hàng & Hoàn Trả -->
          <div>
            <h4 class="font-semibold text-neutral-1000 mb-4">{{ $t('footer.shipping') }}</h4>
            <ul class="space-y-2 text-sm text-neutral-800">
              <li><a href="#" class="text-primary-600 hover:text-neutral-700">{{ $t('footer.policy') }}</a></li>
              <li><a href="#" class="text-primary-600 hover:text-neutral-700">{{ $t('footer.fees') }}</a></li>
              <li><a href="#" class="text-primary-600 hover:text-neutral-700">{{ $t('footer.returns') }}</a></li>
              <li><a href="#" class="text-primary-600 hover:text-neutral-700">{{ $t('footer.tracking') }}</a></li>
            </ul>
          </div>

          <!-- Điều Khoản & Chính Sách -->
          <div>
            <h4 class="font-semibold text-neutral-1000 mb-4">{{ $t('footer.terms') }}</h4>
            <ul class="space-y-2 text-sm text-neutral-800">
              <li><a href="#" class="text-primary-600 hover:text-neutral-700">{{ $t('footer.termsOfUse') }}</a></li>
              <li><a href="#" class="text-primary-600 hover:text-neutral-700">{{ $t('footer.privacy') }}</a></li>
              <li><a href="#" class="text-primary-600 hover:text-neutral-700">{{ $t('footer.cookies') }}</a></li>
              <li><a href="#" class="text-primary-600 hover:text-neutral-700">{{ $t('footer.about') }}</a></li>
            </ul>
          </div>
        </div>
